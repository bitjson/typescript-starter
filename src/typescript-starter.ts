...
(async () => {
  ...
  const nodeDefinitions = [TypeDefinitions.Node, TypeDefinitions.NodeAndDOM].includes(definitions);
  const domDefinitions = [TypeDefinitions.DOM, TypeDefinitions.NodeAndDOM].includes(definitions);
